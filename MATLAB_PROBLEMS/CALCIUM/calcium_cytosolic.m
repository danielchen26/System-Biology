...
S0=[0 1 0 0 0];
% variables in S are the states, in the following order:
% C  R  RI  RIC+  RIC+C
...
%dynamics
dS=[vr*(gamma0+gamma1*S(4))*(Cs-S(1)) - (p1*S(1)^4)/(p2^4+S(1)^4);
    -k1*I*S(2)+km1*S(3);
