...
\item
The program starts with an IP3 concentration that changes from $I=0$ 
to a new value of $I$ at time $t=20$.
With the new $I$ set to 1,
...
14/100 = 0.14.
\item
Modify the program to set the value after $t=20$ to $I=0.7$.
(Open the file calcium\_cytosolic.m using
